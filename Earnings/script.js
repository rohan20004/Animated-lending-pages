...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function smoothScrollLoop() {
    // Linear interpolation easing: target frame gets closer by a percentage per render frame
    const easeFactor = 0.08; // Adjust for scroll weight (lower = more ease/butter)
